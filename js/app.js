...
<br>
<footer class="footer mt-auto py-3 text-muted ${UI.footer_style_class}" style="${UI.fixed_footer ?'position: fixed; ': ''}left: 0; bottom: 0; width: 100%; color: white; z-index: 9999;${UI.hide_footer ? ' display:none;': ' display:block;'}"> <div class="container" style="width: auto; padding: 0 10px;"> <p class="float-end"> <a href="#">Back to top</a> </p> <p>© ${UI.copyright_year} - <a href=" ${UI.company_link}" target="_blank"> ${UI.company_name}</a>, All Rights Reserved.</p> ${UI.credit ? '<p style="font-size:8px;text-align:center;">Redesigned with <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-heart-fill" fill="red" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" /> </svg> by <a href="https://www.npmjs.com/package/@googledrive/index" target="_blank">TheFirstSpeedster</a>, based on Open Source Softwares. </p>' : ''} <p style="text-align:center"><!-- Histats.com  START  (aync)-->
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?4453526&101" alt="web stats service from statcounter" border="0"></a></noscript>
<!-- Histats.com  END  --></p></div></footer>
  `;
    $('body').html(html);
}
...
function utc2delhi(utc_datetime) {
    ...
    // 7.0 hours increase, Indonesia time is seven more time zones than UTC time
